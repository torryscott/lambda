...
| `style=numbers`, `defs=1`, `head=…` | print | Numbered key instead of names on the figure; include definitions; which heading parts to print (`view,count,title,cls,rule` or `none`) |
